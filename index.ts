...
export async function notifyIncomingCall(incomingCall) {
    ...
    console.info("[notifyIncomingCall]", incomingCall);
    ...
    if (Platform.OS === "android") {
        ...
        console.info(`[notifyIncomingCall] displayed notification ${incomingCallNotificationIDs[videoRoomSID]}`);
    } else {
    ...
    console.info("[notifyIncomingCall:DONE]");
}
